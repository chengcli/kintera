...
class EquilibriumOptions:
    ...
    def A(self, value: List[float] = ...) -> Any: ...
    def B2(self, value: List[float] = ...) -> Any: ...
    def B1(self, value: List[float] = ...) -> Any: ...
    def C(self, value: List[float] = ...) -> Any: ...
    def D1(self, value: List[float] = ...) -> Any: ...
    def D2(self, value: List[float] = ...) -> Any: ...
