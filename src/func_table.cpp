...
user_func1 func1_table_cpu[] = {
    ...
    co2_antoine,      co2_antoine_ddT,     kcl_lodders_cond, kcl_lodders_cond_ddT,
    k_hcl_lodders,    k_hcl_lodders_ddT,   mn_h2s_visscher,  mn_h2s_visscher_ddT,
    zn_h2s_visscher,  zn_h2s_visscher_ddT, na_h2s_visscher,  na_h2s_visscher_ddT,
    mg_sih4_visscher, mg_sih4_visscher_ddT};
...
std::vector<std::string> func1_names = {
    ...
    "kcl_lodders_cond",    "kcl_lodders_cond_ddT", "k_hcl_lodders",
    "k_hcl_lodders_ddT",   "mn_h2s_visscher",      "mn_h2s_visscher_ddT",
    "zn_h2s_visscher",     "zn_h2s_visscher_ddT",  "na_h2s_visscher",
    "na_h2s_visscher_ddT", "mg_sih4_visscher",     "mg_sih4_visscher_ddT"};
